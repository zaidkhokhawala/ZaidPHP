        ...
        <div class="row">
            <div class="col-12 ">
                <nav class="navbar navbar-expand-lg">
                    <!-- Logo -->
                    <a href="index.php" class=" navh1"> <!-- Logo left side पर fix -->
                        <h1>Admin Panel</h1>
                    </a>
                ...
                <ul class="navbar-nav gap-4">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" id="productDropdown" data-bs-toggle="dropdown">Product</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="add_product">Add Product</a></li>
                            <li><a class="dropdown-item" href="manage_product">Manage Product</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" id="userDropdown" data-bs-toggle="dropdown">Users</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="add_user.php">Add User</a></li>
                            <li><a class="dropdown-item" href="manage_user.php">Manage Users</a></li>
                        </ul>
                    </li>
                    
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" id="ordersDropdown" data-bs-toggle="dropdown">Orders</a>
                        <ul class="dropdown-menu">
