                ...
                <div class="card p-4 shadow">
                    ...
                    <form id="add-product-form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="img[]" id="property_images" class="form-control" accept="image/*" multiple required>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="category_name" id="category" class="form-select" required>
                                        <option value="" selected>Select Category</option>
                                        <?php foreach ($cat_arr as $d) { ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="parking" id="parking" class="form-control" placeholder="Enter Parking Spots..." required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <button name="submit" style="color: white; background-color: #f35525;" type="submit" id="form-submit" class="btn">Add Property</button>
                        </div>
