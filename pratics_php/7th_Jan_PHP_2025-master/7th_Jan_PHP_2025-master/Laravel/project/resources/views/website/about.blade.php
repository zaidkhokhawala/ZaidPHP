        ...
        <div class="container py-md-5 py-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 about-2-secs-right mt-lg-4 mt-5">
                    <img src="{{url('website/assets/images/about.jpg')}}" alt="" class="img-fluid radius-image" />
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="row align-items-center">
                <div class="col-lg-6 about-2-secs-right mb-lg-0 mb-5">
                    <img src="{{url('website/assets/images/img3.jpg')}}" alt="" class="img-fluid radius-image" />
                </div>
    ...
    <section class="w3l-team py-5" id="team">
        <div class="container py-lg-5 py-md-4 py-2">
            ...
            <div class="row text-center">
                ...
                <div class="team-info col-md-3 col-6 mt-md-0 mt-sm-5 mt-5">
                    <div class="column position-relative">
                        <a href="#url"><img src="{{url('website/assets/images/team4.jpg')}}" alt="" class="img-fluid" /></a>
                    </div>
